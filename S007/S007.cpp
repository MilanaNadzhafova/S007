...
int main()
{
	...
	std::cout << "A program that searches for the first occurrence of the specified mask in a string. Returns the number of the character on which the match was found, or -1 if no match was found.: ";
	std::cout << "\n\nString: ";
